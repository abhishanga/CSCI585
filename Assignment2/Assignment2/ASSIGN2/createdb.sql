create table BUILDING(BUILDING_ID varchar2(30), BUILDING_NAME varchar2(30), NO_OF_VERTICES number(6), SHAPE SDO_GEOMETRY);
INSERT INTO USER_SDO_GEOM_METADATA(TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES('building', 'shape',
...
TRAMSTATION_ID VARCHAR2(10),
STUDENTPOSITION SDO_GEOMETRY,
RADIUS NUMBER,
PRIMARY KEY (TRAMSTATION_ID)
);
INSERT INTO USER_SDO_GEOM_METADATA(TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES('TRAMSTOP', 'STUDENTPOSITION',
SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 820, 0.005), SDO_DIM_ELEMENT('Y', 0, 580, 0.005)), NULL);
CREATE INDEX tramstop_index
ON tramstop(studentposition)
INDEXTYPE IS MDSYS.SPATIAL_INDEX;
INSERT INTO TRAMSTOP VALUES('t1psa',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(180,120,NULL),NULL,NULL),100);
INSERT INTO TRAMSTOP VALUES('t2ohe',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(204,177,NULL),NULL,NULL),70);
INSERT INTO TRAMSTOP VALUES('t3sgm',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(253,81,NULL),NULL,NULL),75);
INSERT INTO TRAMSTOP VALUES('t4hnb',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(476,229,NULL),NULL,NULL),50);
INSERT INTO TRAMSTOP VALUES('t5vhe',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(447,299,NULL),NULL,NULL),50);
INSERT INTO TRAMSTOP VALUES('t6ssl',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(213,432,NULL),NULL,NULL),50);
INSERT INTO TRAMSTOP VALUES('t7helen',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(378,460,NULL),NULL,NULL),100);

CREATE TABLE STUDENTS(
STUDENT_ID VARCHAR(4) NOT NULL,
STUDENTPOS SDO_GEOMETRY,
PRIMARY KEY(STUDENT_ID));
INSERT INTO USER_SDO_GEOM_METADATA(TABLE_NAME, COLUMN_NAME, DIMINFO, SRID) VALUES('STUDENTS', 'STUDENTPOS',
SDO_DIM_ARRAY(SDO_DIM_ELEMENT('X', 0, 820, 0.005), SDO_DIM_ELEMENT('Y', 0, 580, 0.005)), NULL);
CREATE INDEX student_index
ON students(studentpos)
INDEXTYPE IS MDSYS.SPATIAL_INDEX;
